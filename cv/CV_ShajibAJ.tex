...
\section{\sc Publication statistics} 34 total published/submitted papers. {10 first-author}, {2 second-author, and 22 $n$th-author} papers. \textbf{First author citations}: 336, \textbf{total citations:} 2,536, h-index: 21 (11/12/2022, \href{https://ui.adsabs.harvard.edu/user/libraries/NYgiA71JS4CR85Tt8CgJsw}{ADS}).
\vspace*{2.5mm}
...
\section{\sc Colloquium and Seminar Talks}
\begin{enumerate}
...
\textbf{First/second-author publications}
\\ $\dagger$ Mentee
\begin{enumerate}
