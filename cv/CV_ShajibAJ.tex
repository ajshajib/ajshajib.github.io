...
\section{\sc Publication statistics} 21 total refereed papers. \textbf{7 first-author (inc1uding 1 single-author) papers}. \textbf{2 second-author and 12 $n$th-author} papers. \textbf{First author citations: 193, total citations: 1398}, h-index: 16 (06/07/2021, \href{https://ui.adsabs.harvard.edu/user/libraries/NYgiA71JS4CR85Tt8CgJsw}{ADS}).
\vspace*{2.5mm}
...
\begin{enumerate}
	...
	\item Open seminar at Harvard University, USA, April 2021 \textbf{(invited)}.
	\item Survey Science Group Meeting, University of Chicago, USA
...
\begin{itemize}
	\item \textbf{Eden Molina:} UCLA undergraduate student, completed a project to model doubly-imaged lensed quasars from NIRC2 imaging data. Mentored Fall 2018--Winter 2020. Coauthored and published a \href{https://doi:10.1093/mnras/stab532}{paper}.
	\item \textbf{Vedant Sahu:} UCLA undergraduate student, working on a project to apply machine learning techniques in modelling quadruply-lensed quasars. Mentored since Summer 2019.
	\item \textbf{Chin Yi Tan:} UChicago graduate student, working a project to build automated pipeline for modeling galaxy--galaxy lenses. Mentored since Winter 2021.
...
\begin{enumerate}
	...
	\item Wong, C. K., et al. H0LiCOW – XIII. A 2.4 per cent measurement of H0 from lensed quasars: 5.3$\sigma$ tension between early- and late-Universe probes. In press (MNRAS), \href{https://doi.org/10.1093/mnras/stz3094}{MNRAS, 498, 1, 1420-1439, 2020}.
