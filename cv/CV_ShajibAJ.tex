...
\newcommand{\pubstat}{
\section{\sc Publication statistics} 77 total published/submitted papers (listed at the end of CV). \textbf{18 first-author}, \textbf{4 mentee-led} papers with the projects created and mentored by {Shajib}. \\ \textbf{First-author citations}: 921, \textbf{total citations:} 6,082, h-index: 34 (01/27/2026, \href{https://ui.adsabs.harvard.edu/user/libraries/NYgiA71JS4CR85Tt8CgJsw}{ADS}).
}
...
\begin{etaremune}
	\item \textbf{Shajib, A.~J.} \textsc{raccoon}: A Python package for removing wiggle artifacts in the JWST NIRSpec integral field spectroscopy. \href{https://ui.adsabs.harvard.edu/abs/2025arXiv250713341S/abstract}{arXiv:2507.13341, 2025}.
