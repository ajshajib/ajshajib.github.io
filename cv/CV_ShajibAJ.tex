...
\vspace*{.16in}
\begin{list1}
	\item[] \textbf{Postdoctoral Scholar}, Department of Astronomy and Astrophsycis, The University of Chicago, November 2020 -- present.
...
\section{\sc Publication statistics} 21 total refereed/under-review papers. \textbf{7 first-author (inc1uding 1 single-author) papers} (5 refereed, 2 under-review). \textbf{1 second-author and 13 $n$th-author} papers (12 refereed, 2 under-review). \textbf{First author citations: 140, total citations: 813}, h-index: 14 (11/05/2020, \href{https://ui.adsabs.harvard.edu/user/libraries/NYgiA71JS4CR85Tt8CgJsw}{ADS}).
\vspace*{2.5mm}
...
\begin{enumerate}
	\item \textit{Hubble Space Telescope} AR-16149 (2020). PI: Shajib. Systematics in $H_0$ from lensing: a comprehensive study of internal structure in elliptical galaxies.
\end{enumerate}
...
\section{\sc Scientific Software Development} Contributing developer for the lens-modeling software \textsc{lenstronomy} \href{https://github.com/sibirrer/lenstronomy}{\faGithub}.
\\
...
\begin{itemize}
	\item \textbf{Eden Molina:} UCLA undergraduate, completing a project to model doubly-imaged lensed quasars from NIRC2 imaging data. Mentored Fall 2018--Winter 2020.
	\item \textbf{Vedant Sahu:} UCLA undergraduate, working on a project to apply machine learning techniques in modelling quadruply-lensed quasars. Mentored since Summer 2019.
\end{itemize}
...
\begin{enumerate}
	\item \textbf{Shajib, A. J.}, et al. Massive elliptical galaxies at z$\sim$0.2 are well described by stars and a Navarro--Frenk--White dark matter halo. \href{https://arxiv.org/abs/2008.11724}{arXiv:2008.11724, 2020}.
	\item \textbf{Shajib, A. J.}, Molina, E.{$\dagger$}, et al. High-resolution imaging follow-up of doubly imaged quasars. \href{https://arxiv.org/abs/2011.01971}{arXiv:2011.01971, 2020}.
	\item Birrer, S., \textbf{Shajib, A. J.}, et al. TDCOSMO IV: Hierarchical time-delay cosmography -- joint inference of the Hubble constant and galaxy density profiles. Accepted by A\&A, 2020 (\href{https://arxiv.org/abs/2007.02941}{arXiv:2007.02941}).
...
\begin{enumerate}
	\item Ding, X., et al. Time Delay Lens Modelling Challenge: II. Results. \href{https://arxiv.org/abs/2006.08619}{arXiv:2006.08619, 2020}.
	...
	\item Buckley-Geer, E. J., et al. STRIDES: Spectroscopic and photometric characterization of the environment and effects of mass along the line of sight to the gravitational lenses DES J0408$-$5354 and WGD 2038$-$4008. \href{https://arxiv.org/abs/2003.12117}{arXiv:2003.12117, 2020}. 
	\item Lemon, C., et al. The STRong lensing Insights into the Dark Energy Survey (STRIDES) 2017/2018 follow-up campaign: Discovery of 10 lensed quasars and 10 quasar pairs. \href{https://academic.oup.com/mnras/advance-article-abstract/doi/10.1093/mnras/staa652/5801039}{MNRAS, staa652, 2020}.
