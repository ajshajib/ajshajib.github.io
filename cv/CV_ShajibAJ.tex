...
\begin{list1}
	...
	\begin{list2}
		\vspace*{.05in}
		\item Dissertation Topic:  ``Mapping the expansion history of the Universe with strong-lensing time-delays'' 
...
\section{\sc Publication statistics} 13 total refereed/under-review papers. \textbf{4 first-author and 1 single-author} papers (4 refereed, 1 under-review). \textbf{8 co-authored} papers (6 refereed, 2 under-review). Publication list at the end. 
\vspace*{2.5mm}
...
\begin{enumerate}
	...
	\item Galaxies and Cosmology Seminar, Center for Astrophysics, Harvard \& Smithsonian, Massachusetts, USA, October 2019.
	...
	\item MPA Lensing Group Seminar, Munich, Germany, June 2018 (invited).
\end{enumerate}
...
\begin{itemize}
\item Referee for MNRAS and ApJ
