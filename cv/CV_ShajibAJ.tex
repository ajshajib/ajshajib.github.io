...
\textbf{Dissertation Year Fellowship}, UCLA, 2019-2020, \$20,000
...
\section{\sc Publication statistics} 10 refereed papers (including 3 as first author, and one as single author), 3 papers under review (including 1 as first author).
...
\begin{etaremune}
	\item {Shajib, A. J.}, et al. STRIDES: A 3.9 per cent measurement of the Hubble constant from the strong lens system DES J0408--5354. \href{https://arxiv.org/abs/1910.06306}{arXiv:1910.06306, 2019}.
...
\begin{etaremune}
	\item Thursday lunch seminar, Princeton University, New Jersey, USA, October 2019.
	\item Galaxy lunch talk, Yale University, Connecticut, USA, October 2019.
	\item Galaxies and Cosmology Seminar, Center for Astrophysics, Harvard University, Massachusetts, USA, October 2019.
	\item Galaxy journal club, STScI, Maryland, USA, October 2019.
	\item Particle Astrophysics Seminar, Fermilab, Illinois, USA, October 2019.
	\item Lunch talk, Carnegie Observatories, California, USA, September 2019.
	\item Non-Standard Cosmology Probes, Aspen Center of Physics, Colorado, USA, August 2019.
	\item Tensions between the Early and the Late Universe. Kavli Institute for Theoretical Physics, UCSB, USA, July 2019.
...
\begin{itemize}
	...
	\item \textbf{Vedant Sahu:} UCLA undergraduate, working on a project to apply machine learning in modelling quadruply-lensed quasars. Mentored since Summer 2019.
\end{itemize}
...
\begin{etaremune}
	...
	\item Tensions between the Early and the Late Universe. Kavli Institute for Theoretical Physics, UCSB, USA, August 2019.
\end{etaremune}
...
\section{\sc Approved Computing Proposals}
\begin{etaremune}
\item XSEDE Startup Allocation, 200,000 CPU hours (TG-AST190038, 2019). PI: Treu, co-PI: Shajib. Highly-detailed strong-gravitational lens modeling to measure the Hubble constant.   
\end{etaremune}
